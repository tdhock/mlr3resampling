...
same_other_sizes_cv$instance$iteration.dt[, n.train.rows := sapply(train, length)]
same_other_sizes_cv$instance$iteration.dt[n.train.atoms==atoms & seed==1 & test.fold==1]#same as ResamplineSameOtherCV
same_other_sizes_cv$instance$iteration.dt[n.train.atoms != atoms & seed==1]#new ones
```
