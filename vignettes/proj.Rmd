...
In the code above, we set column role `fold` so that splits in the code below will be the same between benchmarking frameworks.
...
We use `ResamplingSameOtherSizesCV` because it respects the `fold` column role.
