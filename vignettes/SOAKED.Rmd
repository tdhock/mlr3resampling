...
In both test subsets (above and below), we see significant differences at full sample size, that disappear at smallest sample size.
...
Especially above, we see that significant differences persist after downsampling, which is a clear indication of a distributional difference between subsets, as expected for the `different` task.
